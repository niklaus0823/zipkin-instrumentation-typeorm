...
class TypeOrmInstrumentation {
    static proxyConnection(conn) {
        conn['proxyQueryBuilder'] = function (target, alias, info = defaultTraceInfo, ctx) {
            const repository = conn['getRepository'].apply(conn, [target]);
